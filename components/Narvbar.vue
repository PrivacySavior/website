<template>
    <div class="initial absolute w-full z-20" ref="menu">
        <div class="menu bg-primary" ref="navmenu">
            ...
            <NuxtLink class="pl-5 pr-5 font-aileron leading-normal text-2xl text-transparent bg-clip-text bg-gradient-to-br from-accent2 to-accent1 relative right-6" :to="demonstration">DEMONSTRATION</NuxtLink>
            <NuxtLink class="pl-5 pr-5 font-aileron leading-normal text-2xl text-transparent bg-clip-text bg-gradient-to-br from-accent2 to-accent1 relative right-6" :to="faq">FAQ</NuxtLink>
        ...
        <div class="w-full h-0 bg-primary flex justify-center flex-col items-center overflow-y-hidden" ref="selection">
            ...
            <li @click="hamburger" class="list-none mb-5"><NuxtLink class="text-2xl font-aileron leading-normal text-transparent bg-clip-text bg-gradient-to-br from-accent2 to-accent1 relative right-6" :to="faq">FAQ</NuxtLink></li>
        </div>
    </div>
</template>
